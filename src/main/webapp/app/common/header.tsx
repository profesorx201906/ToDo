            ...
            <ul className="navbar-nav ms-auto">
              ...
              <li className="navbar-item dropdown">
                ...
                <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="navbarEntitiesLink">
                  <li><Link to="/categories" className="dropdown-item">{t('category.list.headline')}</Link></li>
                  <li><Link to="/todoItems" className="dropdown-item">{t('todoItem.list.headline')}</Link></li>
                </ul>
              </li>
            </ul>
          </div>
