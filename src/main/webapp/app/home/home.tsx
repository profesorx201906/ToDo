  ...
  return (<>
    ...
    <div className="col-md-4 mb-5">
      ...
      <div className="list-group">
        <Link to="/categories" className="list-group-item list-group-item-action">{t('category.list.headline')}</Link>
        <Link to="/todoItems" className="list-group-item list-group-item-action">{t('todoItem.list.headline')}</Link>
      </div>
    </div>
  </>);
}
